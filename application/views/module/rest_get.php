      ...
      <div class="container-fluid">
        <div class="card">
                <div class="card-header">
                    <strong> <?php echo $rp_conf['title']?></strong>
                </div>
                <div class="card-body card-block">
                    <form action="<?php echo base_url('main/c_flex_get/'.$rp_conf['id']);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="card-footer">
                    <input type="submit" id="sendbutton" class="btn btn-primary btn-sm" name="submit" value="submit"></input>
                  	<button type="reset" class="btn btn-danger btn-sm"><i class="fa fa-ban"></i> Clear Form</button>
                </div>
                </form>
            </div>
          </div>
          <?php if($x == 1)$this->load->view('module/get_response')?>
  </div>
</div>
