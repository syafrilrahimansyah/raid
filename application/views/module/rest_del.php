      ...
      <div class="container-fluid">
        <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="<?php echo base_url('main/c_flex_del/'.$rp_conf['id']);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <?php if($x == 1)$this->load->view('module/del_response')?>
  </div>
</div>
