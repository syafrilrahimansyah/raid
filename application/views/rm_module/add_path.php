  ...
  <!-- Modal content-->
    <div class="modal-content" >
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('RM_Main/add_path')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          <div class="row form-group">
              <div class="col col-md-3">
                  <label for="select" class=" form-control-label">Payload ID</label>
              </div>
              <div class="col-12 col-md-9">
                  <select name="act_id" id="select" class="form-control">
      ...
      <div class="modal-content" >
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('RM_Main/add_path')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <input type="text" name="act_id" class="form-control" value="<?php echo $modal['act_id']?>" required hidden="">
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">Payload ID</label>
                </div>
                <div class="col-12 col-md-9">
                    <p><?php echo $modal['act_id'].' - '.$modal['rp_id']?></p>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" name="fltr" class="form-control" value="<?php echo $modal['fltr_id']?>" >
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="select" class=" form-control-label">Value Type</label>
                </div>
                <div class="col-12 col-md-9">
                    <select name="val_type" id="select" class="form-control">
    ...
    <!-- Modal content-->
      <div class="modal-content">
        ...
        <form action="<?php echo base_url('RM_Main/add_path')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="modal-body">
            <p>remove payload id : <?php echo $del['act_id']?></p>
          </div>
          <div class="modal-footer">
