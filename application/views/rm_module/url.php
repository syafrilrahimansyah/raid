  ...
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <div class="overview-wrap">
        ...
        <i class="zmdi zmdi-plus"></i>set URL
        </button>
      </div>
      <br>
  <?php if($alert==null){}
  ...
  <!-- Modal content-->
    <div class="modal-content" >
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('RM_Main/url')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="row form-group">
              ...
              <div class="col-12 col-md-9">
                  <input type="text" name="fltr" class="form-control" value="" >
              </div>
          </div>
          <div class="row form-group">
              <div class="col col-md-3">
                  <label for="text-input" class=" form-control-label">URL Value</label>
              </div>
              <div class="col-12 col-md-9">
    ...
    <!-- Modal content-->
      <div class="modal-content">
        ...
        <form action="<?php echo base_url('RM_Main/url')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="modal-body">
            <p>remove url id : <?php echo $del->gen_id?></p>
          </div>
          <div class="modal-footer">
