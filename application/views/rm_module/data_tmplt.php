  ...
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <div class="overview-wrap">
        <h3 class="title-1">[PUT] Data Template</h3>
        <button class="au-btn au-btn-icon au-btn--blue" data-toggle="modal" data-target="#new">
        <i class="zmdi zmdi-plus"></i>set data template
        </button>
      </div>
      <br>
  <?php if($alert==null){}
          ...
          <tbody>
            <?php foreach ($allCombine as $value) {?>
              <tr data-toggle="modal" data-target="#<?php echo $value['gen_id']?>" id="appadd">
                <td><?php echo $value['act_id'].' - '.$value['rp_id']?></td>
  ...
  <!-- Modal content-->
    <div class="modal-content" >
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('RM_Main/data_tmplt')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="row form-group">
              ...
              <div class="col-12 col-md-9">
                  <input type="text" name="fltr_id" class="form-control" value="" >
              </div>
          </div>
          <div class="row form-group">
              <div class="col col-md-3">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('RM_Main/data_tmplt')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" name="fltr_id" class="form-control" value="<?php echo $modal['fltr_id']?>" >
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
