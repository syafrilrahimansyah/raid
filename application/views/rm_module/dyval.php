  ...
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <div class="overview-wrap">
        <h3 class="title-1">dynamic value</h3>
  ...
  <!-- Modal content-->
    <div class="modal-content" >
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('RM_Main/dyval')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <select name="pos" id="select" class="form-control">
                        <option value="1" <?php echo ($modal['part']==1)?'selected':''?>>None</option>
                        <option value="2" <?php echo ($modal['part']==2)?'selected':''?>>Header</option>
                        <option value="3" <?php echo ($modal['part']==3)?'selected':''?>>Parameter</option>
                    </select>
                </div>
            </div>
            <div class="row form-group">
