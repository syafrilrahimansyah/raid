  ...
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <div class="overview-wrap">
        <h3 class="title-1">Lookup Group</h3>
  ...
  <!-- Modal content-->
    <div class="modal-content" >
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('CM_Main/lookup_group')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="row form-group">
              <div class="col col-md-3">
                  <label for="text-input" class=" form-control-label">Display Type</label>
              </div>
              <div class="col-12 col-md-9">
                  <select name="dsply_tp" id="select" class="form-control" required>
              ...
              <div class="col col-md-9">
                  <select name="member[]" id="multiple-select" multiple="" class="form-control" required>
                    <?php foreach ($allMember as $member) {?>
                      <option value="<?php echo $member->id?>"><?php echo '['.$member->id.'] '.$member->name?></option>
                    <?php }?>
                  </select>
              </div>
          </div>
      ...
      <div class="modal-content" >
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('CM_Main/lookup_group')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="select" class=" form-control-label">Display Type</label>
                </div>
                <div class="col-12 col-md-9">
                    <select name="dsply_tp" id="select" class="form-control">
                        <option value="sel" <?php echo ($modal->dsply_tp=='sel')?'selected':'' ?>>Select</option>
                        <option value="rad" <?php echo ($modal->dsply_tp=='rad')?'selected':'' ?>>Radio</option>
                    </select>
                </div>
            </div>
            <div class="row form-group">
              ...
              <div class="col col-md-9">
                  <select name="member[]" id="multiple-select" multiple="" class="form-control">
                    ...
                    ?>
                    <?php foreach ($allMember as $member) {?>
                      <option value="<?php echo $member->id?>" <?php echo (in_array($member->id,$member_id))?'selected':''?>><?php echo '['.$member->id.'] '.$member->name?></option>
                    <?php }?>
                  </select>
              </div>
            </div>
