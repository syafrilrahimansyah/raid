  ...
  <div class="section__content section__content--p30">
    <div class="container-fluid">
      <div class="overview-wrap">
        <h3 class="title-1">Lookup Member</h3>
  ...
  <!-- Modal content-->
    <div class="modal-content" >
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('CM_Main/lookup_member')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('CM_Main/lookup_member')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" name="value" class="form-control" value="<?php echo $modal->value?>" required>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
    ...
    <!-- Modal content-->
      <div class="modal-content">
        ...
        <form action="<?php echo base_url('CM_Main/lookup_member')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="modal-body">
            <p>remove value id : <?php echo $del->id.' - '.$del->name?></p>
          </div>
          <div class="modal-footer">
